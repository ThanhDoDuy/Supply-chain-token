...
async function interact(){
    ...
    rs = await SupplyChainContract.methods.transfer(receiverBalance, 100000).send({
        from: myAddr,
        gas: 3000000
    })

    receiverBalanceAfter = await SupplyChainContract.methods.balanceOf(receiverAddr).call();
